...
export const recommendationAgent = {
  ...
  run: async (intentJson: string): Promise<string[]> => {
    ...
    const systemPrompt = `
      ...
      Select the optimal combination of books that maximizes relevance and ratings without exceeding the intent budget.
      Return strictly a JSON array of selected product IDs. Example: ["ebook-001", "ebook-004"]
