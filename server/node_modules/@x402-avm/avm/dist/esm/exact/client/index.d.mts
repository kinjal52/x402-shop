...
import { C as ClientAvmSigner, a as ClientAvmConfig } from '../../signer-p0bN6lLm.mjs';
 ...
 * ```
 */
declare function registerExactAvmScheme(client: x402Client, config: AvmClientConfig): x402Client;

export { type AvmClientConfig, registerExactAvmScheme };
