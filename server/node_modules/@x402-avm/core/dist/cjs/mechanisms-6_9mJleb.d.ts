...
declare class x402ResourceServer {
     ...
     */
    createPaymentRequiredResponse(requirements: PaymentRequirements[], resourceInfo: ResourceInfo$1, error?: string, extensions?: Record<string, unknown>, transportContext?: unknown): Promise<PaymentRequired>;
    /**
...
export { type AssetAmount as A, type PaymentPayloadContext as B, type FacilitatorContext as C, type ResourceServerExtension as D, type PaymentRequiredContext as E, type FacilitatorExtension as F, HTTPFacilitatorClient as H, type Money as M, type Network as N, type PaymentPayload as P, type ResourceConfig as R, type SettleResponse as S, type VerifyResponse as V, type PaymentRequirements as a, type SchemeNetworkFacilitator as b, type PaymentRequired as c, type FacilitatorClient as d, type FacilitatorConfig as e, type SchemeNetworkClient as f, type ResourceInfo$1 as g, type SettleResultContext as h, type Price as i, type PaymentRequirementsV1 as j, type PaymentRequiredV1 as k, type PaymentPayloadV1 as l, type VerifyRequestV1 as m, type SettleRequestV1 as n, type SettleResponseV1 as o, type SupportedResponseV1 as p, type VerifyRequest as q, type SettleRequest as r, type SupportedResponse as s, VerifyError as t, SettleError as u, type ResourceInfo as v, type SchemeNetworkServer as w, x402ResourceServer as x, type MoneyParser as y, type PaymentPayloadResult as z };
