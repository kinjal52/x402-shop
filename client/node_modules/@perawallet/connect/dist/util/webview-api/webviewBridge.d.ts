 ...
 */
/// <reference path="../../../../../../src/util/webview-api/webviewBridgeTypes.d.ts" />
import { type Platform } from "./webviewApiTypes";
/**
 ...
 */
export declare function callMobileMethodWithResponse<T>(methodName: MobileMethodName, timeoutMs?: number, params?: unknown): Promise<T>;
/**
 ...
 */
export declare function isMobileMethodAvailable(): boolean;
