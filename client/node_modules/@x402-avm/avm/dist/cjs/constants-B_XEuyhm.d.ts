 ...
 */
declare const CAIP2_NETWORKS: readonly ["algorand:wGHE2Pwdvd7S12BL5FaOP20EGYesN73ktiC1qzkkit8=", "algorand:SGO1GKSzyE7IEPItTxCByw9x8FmnrCDexi9/cOUJOiI="];
/**
 ...
 */
declare const V1_ALGORAND_MAINNET = "algorand-mainnet";
/**
 * V1 network identifier for Algorand Testnet
 */
declare const V1_ALGORAND_TESTNET = "algorand-testnet";
/**
 * All V1 network identifiers
 */
declare const V1_NETWORKS: readonly ["algorand-mainnet", "algorand-testnet"];
/**
 * Mapping from V1 network identifiers to CAIP-2 identifiers
 */
declare const V1_TO_CAIP2: Record<string, string>;
/**
 * Mapping from CAIP-2 identifiers to V1 network identifiers
 */
declare const CAIP2_TO_V1: Record<string, string>;
/**
 ...
 */
declare const USDC_CONFIG: Record<string, {
    asaId: string;
    name: string;
    decimals: number;
}>;
 ...
 * ```
 */
declare const DEFAULT_ALGOD_MAINNET: string;
/**
 ...
 * ```
 */
declare const DEFAULT_ALGOD_TESTNET: string;
/**
 ...
 */
declare const NETWORK_TO_ALGOD: Record<string, string>;
/**
 * Maximum number of transactions in an Algorand atomic group
 */
declare const MAX_ATOMIC_GROUP_SIZE = 16;
/**
 * Minimum transaction fee in microAlgos
 */
declare const MIN_TXN_FEE = 1000;
/**
 ...
 */
declare const MAX_REASONABLE_FEE = 16000;
/**
 * Algorand address regex (58-character base32 string)
 */
declare const ALGORAND_ADDRESS_REGEX: RegExp;
/**
 * Algorand address length in characters
 */
declare const ALGORAND_ADDRESS_LENGTH = 58;

export { ALGORAND_MAINNET_CAIP2 as A, CAIP2_TO_V1 as C, DEFAULT_ALGOD_MAINNET as D, MAX_ATOMIC_GROUP_SIZE as M, NETWORK_TO_ALGOD as N, USDC_MAINNET_ASA_ID as U, V1_ALGORAND_MAINNET as V, V1_ALGORAND_TESTNET as a, V1_NETWORKS as b, V1_TO_CAIP2 as c, ALGORAND_TESTNET_CAIP2 as d, CAIP2_NETWORKS as e, ALGORAND_MAINNET_GENESIS_HASH as f, ALGORAND_TESTNET_GENESIS_HASH as g, USDC_TESTNET_ASA_ID as h, USDC_DECIMALS as i, USDC_CONFIG as j, DEFAULT_ALGOD_TESTNET as k, MIN_TXN_FEE as l, MAX_REASONABLE_FEE as m, ALGORAND_ADDRESS_REGEX as n, ALGORAND_ADDRESS_LENGTH as o };
